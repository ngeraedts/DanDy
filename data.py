...
religion_weapons = {
    "Boccob": "Quarterstaff",
    "Corellon Larethian": "Long Sword",
    "Ehlonna": "Long Bow",
    "Erythnul": "Morningstar",
    "Fharlanghn": "Quarterstaff",
    ...
    "Moradin": "Warhammer",
    "Nerull": "Scythe",
    "Obad Hai": "Quarterstaff",
    "Olidammara": "Rapier",
    "Pelor": "Heavy Mace",
    "St. Cuthbert": "Light Mace",
    "Vecna": "Dagger",
    "Wee Jas": "Dagger",
...
language_list = [
    "Abyssal", "Aquan", "Auran", "Celestial", "Draconic", "Dwarven", "Elven", "Giant",
    "Gnome", "Goblin", "Gnoll", "Halfling", "Ignan", "Infernal", "Orc", "ylvan",
    "Terran", "Undercommon"
]
